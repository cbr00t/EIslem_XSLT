...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          #despatchTable, #ettnTable, #sgkTable {
            border-collapse: collapse;
            border-color: #5588CC;
            font-size: <xsl:value-of select="$genelPunto"/>pt;
          }
        ...
        #lineTable > tbody > tr:first-child > td, #lineTable > tbody > tr:first-child > th {
      ...
      <body style="margin-left=0.6in; margin-right=0.6in; margin-top=0.79in; margin-bottom=0.79in">
        <xsl:for-each select="$XML">
          ...
          <table id="content" style="border-color:blue;" border="0" cellspacing="0px" width="860" cellpadding="0px">
            <tbody>
              <tr valign="top">
                <td width="35%">
                  <!--$supplierPartyTable-begin-->
                  <table id="supplierPartyTable" align="center" border="0" width="100%">
                    <tbody>
                      <tr align="left">
                ...
                <td align="center" valign="top" width="30%">
                  <img style="width: 91px;" align="center" alt="e-Fatura Logo"
              ...
              <tr style="height: 118px;" valign="top">
                <td align="right">
                  ...
                  <table id="customerPartyTable" align="left" border="0" height="80%">
                    <tbody>
                      <tr>
                        <td>
                          <!--<hr/>-->
                              ...
                              <xsl:for-each select="n1:Invoice">
                                <xsl:for-each select="cac:AccountingCustomerParty">
                                  <xsl:for-each select="cac:Party">
                                    <xsl:for-each select="cac:Contact">
                                      <xsl:if
                                      test="cbc:Telephone != '' or cbc:Telefax != ''">
                                        <tr align="left">
                                          <td style="width:469px; " align="left">
                                            <xsl:for-each select="cbc:Telephone">
                                              <span>
                            ...
                            <tbody>
                              ...
                              <!--<xsl:for-each select="n1:Invoice/cac:DespatchDocumentReference">
                                ...
                                <xsl:for-each select="cbc:IssueDate">
                                  <tr style="height:13px;">
                                    <td align="left">
                                      <span>
                                        <xsl:text>İrsaliye Tarih:</xsl:text>
                                      </span>
                                      <span>
                                        <xsl:text>&#160;</xsl:text>
                                      </span>
                              ...
                              <!--<xsl:for-each select="n1:Invoice/cac:OrderReference">
                                <tr style="height:13px;">
                                  <td align="left">
                                    <span>
                                      <xsl:text>Sipariş No/Tarih:</xsl:text>
                                    </span>
                                    <span>
                                      <xsl:text>&#160;</xsl:text>
                                    </span>
                              ...
                              <!-- Sube Kodu ve Adi -->
                              <xsl:if test="(//n1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:AgentParty and (//n1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cac:PartyIdentification/cbc:ID != '' or //n1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cac:PartyName/cbc:Name != ''))">
                                <tr align="left">
                                  <td>
                                    <b>
                                    ...
                                    <span style="font-weight:bold; ">
                                      <font color="#5588CC">
                                        <xsl:if test="//n1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cac:PartyIdentification/cbc:ID">
                                          (<xsl:value-of select="//n1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cac:PartyIdentification/cbc:ID"/>) <xsl:text>&#160;</xsl:text>
                                        </xsl:if>
                                        <xsl:if test="//n1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cac:PartyName/cbc:Name">
              ...
              <xsl:if test="$xroot/cbc:InvoiceTypeCode = 'SGK'">
                <tr>
                  <td align="left" colspan="2">
                    <xsl:text>&#160;</xsl:text>
                  </td>
                ...
                <tr>
                  <td align="left" colspan="2">
                    <table id="sgkTable" valign="top" border="1">
          ...
          <table id="lineTable" width="860">
            <tbody>
              <tr id="lineTableTr">
                ...
                <th id="lineTableTd" align="center">
                  <span style="font-weight:bold;">
                    <xsl:text>Mal-Hiz. Kod</xsl:text>
                  </span>
                </th>
                <!--$barkodBaslik-->
                <th id="lineTableTh" align="center">
                  <span style="font-weight:bold;">
                    <xsl:text>Mal-Hiz. Adı</xsl:text>
                  </span>
                </th>
                <xsl:if test="$xroot/cac:InvoiceLine/cac:Item/cac:AdditionalItemIdentification/cbc:ID [@schemeID='KATDETAY']">
                  <th id="lineTableTh" align="center">
                    <span style="font-weight:bold;">
                ...
                <xsl:if test="$xroot/cac:InvoiceLine/cac:Item/cac:AdditionalItemIdentification/cbc:ID [@schemeID='TAKIP_NO']">
                  <th id="lineTableTh" align="center">
                    <span style="font-weight:bold;">
					            <xsl:choose>
						            <xsl:when test="$xroot/cac:InvoiceLine/cac:Item/cac:AdditionalItemIdentification/cbc:ID [@schemeID='TAKIP_NO_ETIKET']">
							            <xsl:value-of select="($xroot/cac:InvoiceLine/cac:Item/cac:AdditionalItemIdentification/cbc:ID [@schemeID='TAKIP_NO_ETIKET'])[1]"/>
						            </xsl:when>
						            <xsl:otherwise>
                ...
                <xsl:if test="$fiyatGosterimKurali = 'HP' and $xroot/cac:InvoiceLine/cac:Item/cac:AdditionalItemIdentification/cbc:ID [@schemeID = 'NET_FIYAT']">
                  <th id="lineTableTh" align="center">
                    <span style="font-weight:bold;">
                      <xsl:text>Net Fiyat</xsl:text>
                    </span>
                ...
                <xsl:if test="$dovizGosterimKurali = 'X' and /node()/cac:PricingExchangeRate/cbc:CalculationRate">
                  <th id="lineTableTh" align="center">
                    <span style="font-weight:bold;">
                      <xsl:text>Birim Dv.Fiyat</xsl:text>
                    </span>
                  </th>
                </xsl:if>
                <!--$iskOranBaslik-->
                    ...
                    <tbody>
                      ...
                      <xsl:for-each select="n1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
                        ...
                        <tr id="budgetContainerTr" align="right">
                          ...
                          <!--
                          cbc:DocumentTypeCode = "DIP_VERGIORAN_POSTFIX"
		                      cbc:ID = "AAA serbest metin"
		                      cbc:DocumentType = "vergi oran"
                          -->
                          <td id="lineTableBudgetTd" align="right">
                            <xsl:for-each select="cac:TaxCategory/cac:TaxScheme">
                              <xsl:text>&#160;</xsl:text>
                      ...
                      <xsl:for-each select="n1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
                        <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode = '4171'">
                          ...
                          <tr id="budgetContainerTr" align="right">
                            ...
                            <td id="lineTableBudgetTd" align="right" style="font-weight: bold; color: #5588CC;">
                      ...
                      <tr id="budgetContainerTr">
                        ...
                        <td id="lineTableBudgetTd" align="right" class="faturaSonucu" style="color: #5588CC; font-weight: bold;">
                          <xsl:for-each select="n1:Invoice/cac:LegalMonetaryTotal/cbc:PayableAmount">
                            <xsl:value-of select="format-number(., $bedelFormatStr, 'european')"/>
                            <xsl:call-template name="Curr_Type"/>
                          </xsl:for-each>
            ...
            <tr>
              ...
              <td align="right" valign="top">
                <div style="color: #334433; font-weight: bold; font-size: 7pt;">
                  Bu e-Fatura belgesi <a href="#" target="_blank" alt="POLEN YAZILIM">POLEN YAZILIM - VİO TİCARİ programı</a>
        ...
        <table id="notesTable" width="800" align="left">
          <tbody>
            <tr>
              <td>
                <div id="eFaturaAlan" style="margin-top: 2px">
                    ...
                    <xsl:choose>
                      <xsl:when test="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'ETICARET_DIPNOT']">
                        <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'ETICARET_DIPNOT']">
                          <div>
                            <xsl:value-of select="cbc:ID" disable-output-escaping="yes"/>
                          </div>
                        </xsl:for-each>
                      </xsl:when>
                      <xsl:otherwise>
                ...
                <!--<xsl:for-each select="//n1:Invoice/cbc:Note">
                  <xsl:if test=".">
                    <xsl:if test="substring(., 1, 3) = 'POL'">
                      <b>&#160; Not: &#160;&#160;&#160;</b>
                      OZER - 11.09.2014 - SubString 5 hane ileriden aliyordu, nedenini bilmiyoruz
                      <xsl:value-of
  ...
  <xsl:template match="//n1:Invoice/cac:InvoiceLine">
    ...
    <tr id="lineTableTr">
      ...
      <td id="lineTableTd">
        <span class="wrap">
          <!--<b><font color="#5588CC">Ürün:</font></b>-->
          <xsl:text>&#160;</xsl:text>
          <xsl:value-of select="./cac:Item/cbc:Name"/>
          <!--<xsl:if test="./cac:Item/cbc:BrandName">
						<br/>
						<b><font color="#5588CC">özel saha 1:</font></b>
						<xsl:text>&#160;</xsl:text>
						<xsl:value-of select="./cac:Item/cbc:BrandName"/>
					</xsl:if>
          ...
          <xsl:if test="./cac:Item/cbc:Description">
            <br/>
            <b>
              <font color="#5588CC">Açıklama:</font>
            </b>
            <xsl:text>&#160;</xsl:text>
            <xsl:value-of select="./cac:Item/cbc:Description"/>
          </xsl:if>-->
      ...
      <xsl:if test="$xroot/cac:InvoiceLine/cac:Item/cac:AdditionalItemIdentification/cbc:ID [@schemeID='KATDETAY']">
        <td id="lineTableTd" align="left" width="90">
      ...
      <xsl:if test="$xroot/cac:InvoiceLine/cac:Item/cac:AdditionalItemIdentification/cbc:ID [@schemeID='TAKIP_NO']">
        <td id="lineTableTd" align="left" width="120">
          <div>
            <xsl:text>&#160;</xsl:text>
      ...
      <td id="lineTableTd" align="right" width="70">
        <span>
          <xsl:text>&#160;</xsl:text>
      ...
      <xsl:if test="$dovizGosterimKurali = 'X' and /node()/cac:PricingExchangeRate/cbc:CalculationRate">
        <td id="lineTableTd" align="right">
          <span>
            <xsl:text>&#160;</xsl:text>
            <xsl:value-of select="format-number(./cac:Price/cbc:PriceAmount div //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, $fiyatFormatStr, 'european')"/>
      ...
      <td id="lineTableTd" align="right">
        <span>
          ...
          <xsl:value-of select="format-number(./cbc:LineExtensionAmount, $bedelFormatStr, 'european')"/>
